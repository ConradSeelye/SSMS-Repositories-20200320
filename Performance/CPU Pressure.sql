...
A measure of how much of the total wait time is signal wait time
date: 3/4/2019
...
-- ToDo: edit this to capture stats over time
...
Listing 3 will provide a measure of how much of the total wait time is signal wait time.
source: PDF book "SQL Server Performance Tuning Using Wait Statistics"
