...
/****** Object:  Job [-- OPS DBA -- DFK_Build_DBBackup]    Script Date: 2/29/2020 3:23:13 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Instance Maintenance]    Script Date: 2/29/2020 3:23:13 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'-- OPS DBA -- DFK_Build_DBBackup', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [BackupFull]    Script Date: 2/29/2020 3:23:14 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'BackupFull', 
		...
		@command=N'Exec USP_IMDB_Backup_Full [DFK_Build]', 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'BackupFull', 
		...
		@active_start_time=220130, 
		@active_end_time=235959, 
		@schedule_uid=N'084b4dd6-38d4-4943-b35f-87dfde09bcee'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
